...
.delete(function(req, res) {
    // Not specifying delete condition so we delete everything:
...
.patch(function(req, res) {
    Article.updateOne(
        ...
        {$set: req.body}, // the req body is basically a JS object which will land up being
        // in the same format as how the update is to be specified
        function(err) {
            if (err) {
                res.send(err);
            } else {
